...
const testPDFGeneration = async () => {
  try {
    ...
    if (!puppeteer) {
      throw new Error('Puppeteer غير متاح');
    }
    ...
    const testHTML = `
      ...
      <body>
        <div class="test-container">
          ...
          <table>
            <thead>
              <tr><th>البند</th><th>الحالة</th><th>النتيجة</th></tr>
            </thead>
            <tbody>
              <tr><td>دعم العربية</td><td>✅</td><td>يعمل</td></tr>
              <tr><td>اتجاه RTL</td><td>✅</td><td>يعمل</td></tr>
              <tr><td>طباعة A4</td><td>✅</td><td>يعمل</td></tr>
            </tbody>
          </table>
