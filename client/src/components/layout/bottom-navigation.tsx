...
import { Home, Users, Receipt, BarChart, CreditCard, Building2, Truck, Filter } from "lucide-react";
...
const navigationItems = [
  ...
  { path: "/workers-filter-report", icon: Filter, label: "تصفية العمال", key: "workers-filter" },
];
